...
{   
     ...
     * 
     * [getMovieInfo description]
     * @param  [type]  $title        [description]
     * @param  boolean $getExtraInfo [description]
     ...
     * [getMovieInfoById description]
     * @param  [type]  $imdbId       [description]
     * @param  boolean $getExtraInfo [description]
     * @return [type]                [description]
     */
     ...
     * @param  [type]  $imdbUrl      [description]
     * @param  boolean $getExtraInfo [description]
     * @return [type]                [description]
     */
    private function scrapeMovieInfo($imdbUrl, $getExtraInfo = true)
    {
        ...
        $arr['country'] = $this->match_all('/<a.*?>(.*?)<\/a>/ms', $this->match('/Country:(.*?)(<\/div>|>.?and )/ms', $html, 1), 1)[0];
     ...
     * 
     * [getRecommendedTitles description]
     * @param  [type] $titleId [description]
     * @return [type]          [description]
     */
    ...
    public function getVideos($titleId){
        ...
        return array_filter($videos)[0];
    }
     
    /**
     * Get Top 250 Movie List
     * 
     * [getTop250 description]
     * @return [type] [description]
     */
     ...
     * 
     * [getIMDbIdFromSearch description]
     * @param  [type] $title  [description]
    ...
    /**
     * [match_all_key_value description]
     * @param  [type]  $regex      [description]
     * @param  [type]  $str        [description]
     * @param  integer $keyIndex   [description]
     * @param  integer $valueIndex [description]
     * @return [type]              [description]
     */
